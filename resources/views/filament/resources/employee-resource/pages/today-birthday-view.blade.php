{{-- <x-filament-panels::page> --}}
    <div x-data="birthdayComponent()" class="relative">
        <div class="flex items-center justify-center bg-cover" style="background-image: url('{{ asset('/images/birthday_card.jpg') }}'); height: 60vh;">
